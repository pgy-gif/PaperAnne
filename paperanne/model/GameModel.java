...
public class GameModel {
    ...
    private final List<PaperData> papers = new ArrayList<>();
    ...
    public GameModel() {
        // 初始化初始关卡数据
        papers.add(new PaperData(200, 400, 150, 30, 0, "platform"));
        papers.add(new PaperData(400, 300, 80, 100, 90, "wall"));
        papers.add(new PaperData(500, 350, 120, 20, 0, "bridge"));
        papers.add(new PaperData(600, 200, 100, 25, 0, "movingPlatform"));
    }
